...
High-context development surface for **Embedded Alerts**. Split repositories remain independently releasable; this monorepo provides a small, buildable control plane for local integration, contract validation, and repository-family orchestration.

## Package composition

The root is a Zed package that composes clients, interfaces, shared libraries, sync, and shared authentication. It intentionally does **not** import `eal-infra` or `eal-cli`.
